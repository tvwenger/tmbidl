pro calibrateRRL,srcName,polType,lineType,scanType,contFile=contFile,outFile=outFile,$
                 fitDefault=fitDefault,help=help
;+
...
;
;===========================================================================================   
;CALLING SEQUENCE: calibrateRRL,srcName,polType,lineType,contFile=contFile,outFile=outFile,&
;                               fitDefault=fitDefault,help=help
;===========================================================================================   
;
;INPUTS:  
...
;
;
;EXAMPLE: calibrateRRL, 'DR21', 'LL', 'H91', 'EPAV', fitDefault=1
;
;-
;MODIFICATION HISTORY:
;    01 Oct 2008 - Dana S. Balser
;    24 Feb 2009 - (dsb) Modify to use with new version of bb.pro.
;    14 Dec 2012 - (dsb) Add scan type.
;    15 Dec 2012 - (dsb) Modify continuum file I/O.
;     9 May 2013 - tmb added /help and !debug
;-
on_error,!debug ? 0 : 2
compile_opt idl2
if keyword_set(help) then begin & get_help,'calibrateRRL' & return & endif
;
;set defaults
...
for i=0,!nsave_max-1 do begin 
    if (!nsave_log[i] eq 1) then begin 
        ...
        if (sname eq srcName) and (pol eq polType) and (lineid eq lineType) and (stype eq scanType) then begin
