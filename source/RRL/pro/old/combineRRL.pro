...
; of all RRLs. 
;   
;CALLING SEQUENCE: combineRRL, nsaveList, nsaveRef, fwhmRef, hpbwList, hpbwRef, nsaveOut=nsaveOut, noquery=noquery
;
;INPUTS:  
...
pro combineRRL, nsaveList, nsaveRef, fwhmRef, hpbwList, hpbwRef, nsaveOut=nsaveOut, noquery=noquery
