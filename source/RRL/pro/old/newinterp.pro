...
;                  nsaveLOchMinus=chMinus, chPlus=chPlus, nsaveOut=nsaveOut,
;                  lineOffset=lineOffset, noquery=noquery
;
;INPUTS:  
...
;
;-
pro interpRRL_rvsys, nsaveList, nsaveRef, nsaveTrack, chMinus=chMinus, chPlus=chPlus, nsaveOut=nsaveOut, lineOffset=lineOffset, noquery = noquery
...
dopplerFreqTrack = restFreq[indexTrackLine] - restFreq[indexTrackLine]*(1.0 - rvsys/!light_c)/sqrt(1.0 - (rvsys/!light_c)^2)
...
dopplerFreqRef = restFreq[indexRefLine] - restFreq[indexRefLine]*(1.0 - rvsys/!light_c)/sqrt(1.0 - (rvsys/!light_c)^2)
dopplerChanDelta = (dopplerFreqTrack - dopplerFreqRef)/!b[0].delta_x
...
for i=0,n_elements(nsaveList)-1 do begin
    ...
    dopplerFreqSig = restFreq[indexSigLine] - restFreq[indexSigLine]*(1.0 - rvsys/!light_c)/sqrt(1.0 - (rvsys/!light_c)^2)
    dopplerChanDelta = (dopplerFreqTrack - dopplerFreqSig)/!b[0].delta_x
