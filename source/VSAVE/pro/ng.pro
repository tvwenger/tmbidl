...
;            =========
;
;   ng   Multiple gaussian fit to !b[0].data  
;   -  
...
;       if keyword \noprint is set print is turned off
;
; V5.0 July 2007
...
;
; 
yunits=string(!b[0].yunits)
if doprt eq 1 then begin
              print,"G#       Height +/- sigma    Center +/- sigma"+ $
                    "      FWHM +/- sigma  ==>  kHz       km/sec"
              print,yunits,format='(10x,A8)'
              print
              end
;
...
!gfit_rms=dsig
if doprt then begin
    print,'RMS in NREGIONs = ', dsig,yunits
end
