pro write_archive_FITINFO,archive,help=help
;+
; NAME:
...
;   
;   ===============================================
;   Syntax: write_archive_FITINFO,archive,help=help
;   ===============================================
;
; V5.0 July 2007
...
compile_opt idl2
;
if keyword_set(help) then begin & get_help,'write_archive_FITINFO' & return & endif 
;
