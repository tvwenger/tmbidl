pro decx,flag,help=help
;+
; NAME:
;      DECX
;
;            ============================
;            Syntax: decx, flag,help=help
;            ============================
;
;   decx    Sets system flag to display DECLINATION on x-axis
;   ----    (continuum mode only)
;
...
;
; V5.0 July 2007  TMB modified to keep !y.range intact
;      Nov  2007  modified to toggle !x.title with !relative
...
compile_opt idl2
;
if keyword_set(help) then begin & get_help,'decx' & return & endif
;
...
;
!chan=0 & !velo=0 & !freq=0 & !azxx=0 & !elxx=0 & !raxx=0 & !decx=1 &
;
def_xaxis,num_pts
x=!xx[0:num_pts-1]
