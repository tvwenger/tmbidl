pro elxx,flag,help=help
;+
; NAME:
;      ELXX
;
;   elxx    Sets system flag to display ELEVAION on x-axis
;   ----    CONTINUUM mode only
;
;           ======================
;           Syntax: elxx,help=help
;           ======================
;
...
compile_opt idl2
;
if keyword_set(help) then begin & get_help,'elxx' & return & endif
;
...
;
!chan=0 & !velo=0 & !freq=0 & !azxx=0 & !elxx=1 & !raxx=0 & !decx=0 &
;
def_xaxis,num_pts
x=!xx[0:num_pts-1]
