PRO freegfix,help=help
;+
; NAME:
;       FREEGFIX
;
;            ==========================
;            Syntax: freegfix,help=help
;            ==========================
;
;   freegfix  Restore the !parinfo[] structure variables to state 
;   --------  wherein ALL variables are free during the fit.
;
...
compile_opt idl2
;
if keyword_set(help) then begin & get_help,'freegfix' & return & endif
;
for i=0,3*!ngauss_max-1 do begin 
      !parinfo[i].fixed=0
      !parinfo[i].value=0.d
endfor
;
