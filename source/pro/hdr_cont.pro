pro hdr_cont,rec,help=help
;+
; NAME:
;       HDR_CONT
;
;            ================================
;            Syntax: hdr_cont, rec#,help=help
;            ================================
;
;   hdr_cont  Prints header variables for a single data record.
;   --------  e.g. a single subcorrelator spectrum for a specific scan
;             This version is for GBT CONTINUUMdata. 
;
...
;-
if keyword_set(help) then begin & get_help,'hdr_cont' & return & endif
;
