pro psopen, filename, $
            ...
            _REF_EXTRA=_extra, carl=carl, help=help
;+
; NAME:
...
;
; ==> TMBIDL modification: TMB 14mar2010 
;     v6.1 tmb 03aug2010  Farting around with the symbol sizes
; V7.0 03may2013 tvw - added /help, !debug
;
;-
if keyword_set(help) then begin & get_help,'psopen' & return & endif
;take care of 'CARL'
...
;
; SET PARAMETERS FOR STANDARD POSTSCRIPT PLOT
;
!p_old=!p & !x_old=!x & !y_old=!y & !z_old=!z
!p.font=2
!p.charsize=1.
!p.charthick=2
!p.thick=2
...
device, FILENAME  = filename, $
        ...
        FONT_SIZE=8, $   ; hardwire for now. default of 12 points is too big
        _EXTRA    = _extra 
;
return
end; psopen
