pro putavns,ns,help=help     ; either input the nsave location explicitly or use !nsave value
;+
; NAME:
;       PUTAVNS
;
;            =======================================
;            Syntax: putavns, nsave_slot_#,help=help
;            =======================================
;
...
; v7.1 15may2013 tvw - fixed bug, only want to write nslog[0:!nsave_max-1]
;-
;
on_error,!debug ? 0 : 2
compile_opt idl2
if keyword_set(help) then begin & get_help,'putavns' & return & endif
;
...
writeu,!nslogunit,!nsave_log[0:!nsave_max-1]
close,!nslogunit
;                        
return
end
