...
pro which, proname,help=help
;+
; NAME:
;       WHICH
;
;            ==================================================
;            Syntax: which, 'fully_qualified_proname',help=help
;            ==================================================
;
; Written by Tim Robishaw
;
; PURPOSE: 
...
on_error,!debug ? 0 : 2
if keyword_set(help) then begin & get_help,'which' & return & endif
